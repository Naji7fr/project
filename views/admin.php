...
<body class="min-h-screen bg-gray-50">
    ...
    <nav class="bg-white shadow-lg border-b border-gray-200">
        <div class="container mx-auto px-4 py-3 flex justify-between items-center">
            ...
            <div class="flex items-center space-x-4">
                ...
                <a href="/sellers" class="text-gray-600 hover:text-black transition-colors" title="Verkopers">
                    <i data-feather="users" class="w-5 h-5"></i>
                </a>
                <span class="text-black font-medium">Events</span>
    ...
    <div class="container mx-auto px-4 py-8">
        ...
        <div class="bg-blue-50 border border-blue-200 rounded-lg p-4 mb-6">
            <h3 class="text-lg font-semibold text-blue-900 mb-3">Quick Test Data</h3>
            <div class="flex flex-wrap gap-2">
                <button onclick="fillUpcomingEvent()" class="bg-green-500 text-white px-4 py-2 rounded-lg hover:bg-green-600 transition-colors text-sm">
                    Fill Sample Event Data
                </button>
                <button onclick="clearForm()" class="bg-red-500 text-white px-4 py-2 rounded-lg hover:bg-red-600 transition-colors text-sm">
                    Clear Form
                </button>
            </div>
        </div>
        ...
        <div class="bg-white rounded-lg shadow-md p-6 mb-8">
            <h2 id="formTitle" class="text-xl font-bold text-gray-900 mb-4">Add New Event</h2>
            <form id="addEventForm" class="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div>
                    ...
                    <input type="date" id="date" name="date" required 
                           class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-black">
                    <p class="text-xs text-gray-500 mt-1">Select a date between today and 6 months from now</p>
                </div>
                <div>
