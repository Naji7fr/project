...
<head>
    ...
    <title>Sneakerness - Sneaker Events Worldwide</title>
...
<body class="min-h-screen bg-white text-black">
    ...
    <section class="relative pt-32 pb-20 overflow-hidden bg-white">
        <div class="container mx-auto px-4 relative z-10 text-center">
            <h1 class="text-4xl md:text-6xl font-bold mb-6 tracking-tight">
                <span class="text-black">SNEAKER EVENTS</span> <br>WORLDWIDE
            </h1>
            <p class="text-xl md:text-2xl mb-8 text-gray-600 max-w-2xl mx-auto">
                The ultimate sneaker convention for collectors and enthusiasts
            </p>
            ...
            <div class="mt-16 grid grid-cols-2 md:grid-cols-4 gap-6 max-w-4xl mx-auto">
                <div class="bg-white p-4 rounded-xl border border-gray-200" data-aos="fade-up">
                    <div class="text-black mb-2">
                        <i data-feather="calendar" class="w-8 h-8"></i>
                    </div>
                    <h3 class="font-bold">12+ Events</h3>
                    <p class="text-sm text-gray-500">Worldwide</p>
                </div>
                <div class="bg-white p-4 rounded-xl border border-gray-200" data-aos="fade-up" data-aos-delay="100">
                    <div class="text-black mb-2">
                        <i data-feather="users" class="w-8 h-8"></i>
                    </div>
                    <h3 class="font-bold">50K+</h3>
                    <p class="text-sm text-gray-500">Attendees</p>
                </div>
                <div class="bg-white p-4 rounded-xl border border-gray-200" data-aos="fade-up" data-aos-delay="200">
                    <div class="text-black mb-2">
                        <i data-feather="shopping-bag" class="w-8 h-8"></i>
                    </div>
                    <h3 class="font-bold">200+</h3>
                    <p class="text-sm text-gray-500">Exhibitors</p>
                </div>
                <div class="bg-white p-4 rounded-xl border border-gray-200" data-aos="fade-up" data-aos-delay="300">
                    <div class="text-black mb-2">
                        <i data-feather="star" class="w-8 h-8"></i>
                    </div>
                    <h3 class="font-bold">50+</h3>
                    <p class="text-sm text-gray-500">Special Drops</p>
                </div>
            </div>
        </div>
    </section>
    ...
    <section id="events" class="py-16 container mx-auto px-4 relative bg-white">
        <h2 class="text-3xl font-bold text-center mb-12 relative text-black">
            UPCOMING EVENTS
            <div class="absolute bottom-0 left-1/2 transform -translate-x-1/2 w-16 h-1 bg-black rounded-full"></div>
        </h2>
        <!-- Tabs -->
        ...
        <div class="container mx-auto px-4">
            ...
            <div class="grid grid-cols-2 md:grid-cols-4 gap-8 mb-8">
                <div>
                    ...
                    <ul class="space-y-2">
                        <li><a href="#" class="text-gray-400 hover:text-white transition">Upcoming</a></li>
                        <li><a href="#" class="text-gray-400 hover:text-white transition">Past Events</a></li>
                        <li><a href="#" class="text-gray-400 hover:text-white transition">Exhibitors</a></li>
                    </ul>
                </div>
                <div>
